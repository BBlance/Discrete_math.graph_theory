...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(-50, 0, 800, 600))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 10, 251, 621))
        ...
        self.undoView.setGeometry(QtCore.QRect(0, 0, 241, 591))
        self.undoView.setObjectName("undoView")
        self.tabWidget.addTab(self.tab, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.listView = QtWidgets.QListView(self.tab_2)
        self.listView.setGeometry(QtCore.QRect(0, 10, 241, 581))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/images/ARC.BMP"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionArc.setIcon(icon7)
        self.actionArc.setObjectName("actionArc")
        self.actionStraight_Line = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/images/LINE.BMP"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStraight_Line.setIcon(icon8)
        self.actionStraight_Line.setObjectName("actionStraight_Line")
        self.actionCircle = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/images/ELLIPSE.BMP"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCircle.setIcon(icon9)
        self.actionCircle.setObjectName("actionCircle")
        self.actionRectangle = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/images/RECTANGL.BMP"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRectangle.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/images/800.bmp"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionAdd_Annotation.setIcon(icon11)
